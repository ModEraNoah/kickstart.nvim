...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>fca', builtin.git_commits, { desc = '[F]ind [C]ommits all' })
      vim.keymap.set('n', '<leader>fcb', builtin.git_bcommits, { desc = '[F]ind [C]ommits of [B]uffer' })
  ...
  },
  {
    ...
    opts = {
      options = {
        icons_enabled = true,
        theme = function()
          return require 'lualine.themes.OceanicNext'
        end,
      },
      sections = {
        lualine_a = { 'mode' },
    ...
    config = function()
      require('nvim-tree').setup {
        on_attach = function(bufnr)
          ...
          -- custom mappings
          vim.keymap.set('n', '+', api.tree.change_root_to_node, opts 'go into')
        end,
      }
    end,
  },
